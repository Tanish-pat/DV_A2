...
async function fetch_data() {
    ...
    try {
        const response = await fetch('csv_building_ownership_and_use.csv');
        ...
        Papa.parse(csvData, {
            ...
            step: function (row) {
                ...
                const damage_level = row.data['legal_ownership_status'];
...
function preparePlotData() {
    ...
    const layout = {
        title: 'Parallel Coordinate Plot For Legal Ownership Status Of Buildings',
        width: 1750,
        height: 800,
